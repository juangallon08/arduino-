...
const int pinT2   = 3;         // T2
const int pinT3   = 1;         // T3
const int pinI1   = 2;    // I1*******
...
const int limT3   = 50;       // T2 high alarm (°C)
...
void dispatchCommand(void) {
  if (cmd == "A") {
    ...
    sendResponse(String(readTemperature(pinT3)));
    sendResponse(String(readCurrent(pinI1)));
    sendResponse(String(readCurrent(pinI2)));
    sendResponse(String(Q1));
    sendResponse(String(Q2));
  }
  else if (cmd == "T1") {
